...
- git 자료 일부 받기 : 
  - 사이트: [down git](https://github.com/xidoWeb/smart_210901/tree/main/b_curriculum)
  - 앱 : git zip (사용시 오른버튼 클릭 후)

- w3 validator 앱(플러그인) - 버그이슈 많은 사용 자재 (대안 찾는중)
...
- font
  ...
  - font-family : 
    - 서체를 선택 하는 속성으로 
    - 사용할영문, 대안, 대중적인 , 사용할 한글, 대안, 서체의큰범위;
  - font-weight :
    - 서체의 굵기
  ...
  - font-style :
    ...
    - normal, italic
  - line-height :
    - 행간 - 텍스트와 텍스트 사이의 줄(위/아래)간격으로, **leading**과 다른 개념
    - %, 단위없는 수치(기본서체크기 기준 scale)
  - font-size :
